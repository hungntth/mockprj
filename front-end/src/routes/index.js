...
// import CandidateAction from "../pages/candidate/CandidateAction";
...
// candidate
const Candidate = async(() => import("../pages/candidate/Candidate"));
const CandidateAction = async(() => import("../pages/candidate/CandidateAction"));
const UpdateCandidate = async(() => import("../pages/candidate/UpdateCandidate"));
...
const candidateRoutes = {
  ...
  name: "Candidate",
  icon: ListIcon,
  component: withAuth(Candidate),
  children: null
};

const CandidateActionRoutes = {
  path: "/candidates/candidateaction",
  name: "CandidateAction",
  component:withAuth( CandidateAction),
  children: null
}
const UpdateCandidateRoutes = {
  path: '/candidates/:id/EditCandidate',
      name: 'EditCandidate',
      main: ({ match }) => <UpdateCandidate match={match} />,
      component: withAuth(UpdateCandidate),
      children: null
}
...
export const dashboard = [
  ...
  profileRoutes,
  settingsRoutes,
  CandidateActionRoutes,
  UpdateCandidateRoutes
